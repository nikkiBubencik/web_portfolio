...
const Home: React.FC = () => {
    return (
        <div className=" section-container home-page page-layout">
            ...
            <div>
                <h2>About Me</h2>
                <p>Hi, I am Nicole Bubencik, a graduate student in Computer Information Systems with a concentration in Web Application Development at Boston University. I graduated with a Bachelor's degree in Computer Science and Mathematics in May. I am passionate about building innovative web applications and solving complex problems through technology. My academic background has given me a strong foundation in both theoretical concepts and hands-on development, and I am eager to apply this knowledge in a professional setting.</p>
                <p>Through my academic and professional experiences, I have gained knowledge in technologies such as React, JavaScript, Python, and more. In my IT Tech role, I taught myself React to automate an internal visitor management system that was previously manual. The system now allows visitors to sign in, automatically determine if they need to sign a new or updated Confidentiality Disclosure Agreement (CDA), and prints a badge based on their citizenship status—blue for U.S. citizens and yellow for others. This project not only improved operational efficiency but also reinforced my skills in web development, problem-solving, and full-stack integration.</p>
                <p>I am excited to continue developing my skills and contribute to impactful projects in the web development field.</p>
